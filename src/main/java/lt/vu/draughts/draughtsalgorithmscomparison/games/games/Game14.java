...
public class Game14 {
    ...
    public Game returnGame(){
        ...
        GameMove gameMove201 = new GameMove();
        gameMove201.getMoves().add("c1-d2");
        gameMove201.setCurrentPosition(
                new int[][]{
                        {6, 2, 6, 2, 6, 2, 6, 2},
                        {2, 6, 2, 6, 2, 6, 5, 6},
                        {6, 5, 6, 5, 6, 5, 6, 2},
        ...
        game.getPositions().add(gameMove201);
        GameMove gameMove21 = new GameMove();
        gameMove21.getMoves().add("c7-b6");
        ...
        GameMove gameMove301 = new GameMove();
        gameMove301.getMoves().add("f8:d6");
        gameMove301.setCurrentPosition(
                new int[][]{
                        {6, 2, 6, 2, 6, 5, 6, 5},
                        {2, 6, 5, 6, 5, 6, 5, 6},
                        {6, 5, 6, 2, 6, 2, 6, 2},
        ...
        game.getPositions().add(gameMove301);
        GameMove gameMove31 = new GameMove();
        gameMove31.getMoves().add("d4-c5");
        ...
        gameMove35.getMoves().add("e3:c5:a3");
        ...
        GameMove gameMove37 = new GameMove();
        gameMove37.getMoves().add("c3-d4");
        gameMove37.setCurrentPosition(
                new int[][]{
                        {6, 5, 6, 2, 6, 5, 6, 5},
                        {2, 6, 2, 6, 5, 6, 5, 6},
                        {6, 5, 6, 5, 6, 5, 6, 2},
        ...
        game.getPositions().add(gameMove37);
        GameMove gameMove38 = new GameMove();
        gameMove38.getMoves().add("c7-b6");
        gameMove38.setCurrentPosition(
                new int[][]{
                        {6, 5, 6, 2, 6, 5, 6, 5},
                        {2, 6, 5, 6, 5, 6, 5, 6},
                        {6, 2, 6, 5, 6, 5, 6, 2},
        ...
        game.getPositions().add(gameMove38);
        GameMove gameMove39 = new GameMove();
        gameMove39.getMoves().add("b2-c3");
        gameMove39.setCurrentPosition(
                new int[][]{
                        {6, 5, 6, 2, 6, 5, 6, 5},
                        {2, 6, 5, 6, 5, 6, 5, 6},
                        {6, 2, 6, 5, 6, 5, 6, 2},
        ...
        game.getPositions().add(gameMove39);
        return game;
    }
}
