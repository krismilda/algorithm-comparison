...
public class Game15 {
    ...
    public Game returnGame(){
        ...
        GameMove gameMove331 = new GameMove();
        gameMove331.getMoves().add("a3:c5");
        gameMove331.setCurrentPosition(
                new int[][]{
                        {6, 5, 6, 5, 6, 2, 6, 5},
                        {2, 6, 2, 6, 2, 6, 5, 6},
                        {6, 5, 6, 5, 6, 2, 6, 1},
        ...
        game.getPositions().add(gameMove331);
        GameMove gameMove34 = new GameMove();
        gameMove34.getMoves().add("c7-d6");
